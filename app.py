...
with col3:
    arma_input = st.selectbox("Arma para comparação de volume", list(SKINS_COMPARACAO.keys()))
...
if analisar and skin_input:
    ...
    if df is None:
        ...
        skins_comp = SKINS_COMPARACAO.get(arma_input, [])
        volumes_comp = []
        for s in skins_comp:
        ...
        with col1:
            ...
            st.markdown(
                f"Liquidez comparada a outras skins de **{arma_input}**: "
